 ...
 *    2. 下一帧触发 .skeleton-exit.fading（溶解：scale 0.96 + blur 5px + opacity 0，~700ms），
 *    3. 内容同时挂载，以 .content-enter 浮现（scale 0.97→1 + blur 3px→0 + opacity 0→1，750ms 含 100ms 延迟），
 *    4. 两条动画重叠 ~600ms，形成无缝 morph；750ms 后卸载骨架 DOM。
